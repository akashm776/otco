"""Run pressure-matched uniform top-8 CLIP treatment on A100 Colab."""
...
EXPERIMENT_NAME = "cub200_clip_vit_b32_uniform_top8_relative_pressure_matched"
CONFIG_FILE = "configs/hf_cub200_clip_vit_b32_uniform_top8_relative_pressure_matched.yaml"
PINNED_COMMIT = "43182765ad92e5ead1630ced15acd101fa795642"
...
subprocess.run(
    [
        ...
        "-m",
        "py_compile",
        "model/clip_training.py",
        "src/clip_training_data.py",
        "src/clip_training_eval.py",
        "src/clip_train.py",
    ],
    check=True,
)
subprocess.run(
    [sys.executable, "-m", "pytest", "-q", "tests/test_clip_training.py"],
    check=True,
)
