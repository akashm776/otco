...
CONFIG_NAME = "hf_flickr30k_softmax_mix_k32_from_baseline"
...
checkpoint_dir = "/content/drive/MyDrive/otco_checkpoints/softmax_mix_k32_from_baseline"
...
if not os.path.exists(latest_path):
    if os.path.exists(baseline_best):
        ...
        print("Bootstrap complete — OT-Mix will start from baseline weights, epoch 0")
    else:
