...
# ── CONFIG ────────────────────────────────────────────────────────────────────
# Point this at whatever checkpoint dir holds your epoch_5.pt ... epoch_25.pt
CHECKPOINT_DIR = "/content/drive/MyDrive/otco_checkpoints/softmax_mix_k32_a005_scratch"
EPOCHS_TO_EVAL = [5, 10, 15, 20, 25]
# Config that matches the run (dataset backend, model names)
RUN_CONFIG = "configs/hf_flickr30k_softmax_mix_k32_logit_a05_adaptive_scratch.yaml"
# ─────────────────────────────────────────────────────────────────────────────
