...
CONFIG_NAME = "hf_flickr30k_continued_baseline"
...
checkpoint_dir = "/content/drive/MyDrive/otco_checkpoints/continued_baseline"
...
if not os.path.exists(latest_path):
    if os.path.exists(baseline_best):
        ...
        print("Bootstrap complete — continued baseline starts from baseline weights, epoch 0")
    else:
